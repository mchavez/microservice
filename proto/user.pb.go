...
const file_proto_user_proto_rawDesc = "" +
	...
	".user.UserR\x05users2Y\n" +
	"\vUserService\x12'\n" +
	"\bGetUsers\x12\v.user.Empty\x1a\x0e.user.UserList\x12!\n" +
	"\aAddUser\x12\n" +
	".user.User\x1a\n" +
	".user.UserB\x1aZ\x18microservice/proto;protob\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	1, // 2: user.UserService.AddUser:input_type -> user.User
	2, // 3: user.UserService.GetUsers:output_type -> user.UserList
	1, // 4: user.UserService.AddUser:output_type -> user.User
